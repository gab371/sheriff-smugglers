...
export const CARD_THEMES: Record<DeckTheme, { [cardId: string]: Omit<Card, "uid" | "cardId"> }> = {
  WESTERN: {
    corn: { id: "corn", name: "Maïs", type: "LEGAL", icon: "🌽", value: 2, fine: 2, deckCount: 48, baronBonus: 20, trafiquantBonus: 10 },
    potato: { id: "potato", name: "Pommes de terre", type: "LEGAL", icon: "🥔", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    beans: { id: "beans", name: "Haricots", type: "LEGAL", icon: "🫘", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    cotton: { id: "cotton", name: "Coton", type: "LEGAL", icon: "🌾", value: 4, fine: 2, deckCount: 24, baronBonus: 10, trafiquantBonus: 5 },
  ...
  MEDIEVAL: {
    apple: { id: "apple", name: "Pommes", type: "LEGAL", icon: "🍎", value: 2, fine: 2, deckCount: 48, baronBonus: 20, trafiquantBonus: 10 },
    cheese: { id: "cheese", name: "Fromage", type: "LEGAL", icon: "🧀", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    bread: { id: "bread", name: "Pain", type: "LEGAL", icon: "🍞", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    chicken: { id: "chicken", name: "Poulet", type: "LEGAL", icon: "🍗", value: 4, fine: 2, deckCount: 24, baronBonus: 10, trafiquantBonus: 5 },
  ...
  MODERN: {
    soda: { id: "soda", name: "Soda", type: "LEGAL", icon: "🥤", value: 2, fine: 2, deckCount: 48, baronBonus: 20, trafiquantBonus: 10 },
    chocolate: { id: "chocolate", name: "Chocolat", type: "LEGAL", icon: "🍫", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    mug: { id: "mug", name: "Mug", type: "LEGAL", icon: "☕", value: 3, fine: 2, deckCount: 36, baronBonus: 15, trafiquantBonus: 10 },
    figurine: { id: "figurine", name: "Figurine", type: "LEGAL", icon: "🧸", value: 4, fine: 2, deckCount: 24, baronBonus: 10, trafiquantBonus: 5 },
